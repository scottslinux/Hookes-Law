...
Button::Button(Vector2 loc, float scale, std::string labeltext)
{
...
void Button::draw()
{
    ...
    if(value)
        DrawTextEx(pencil,"ACTIVATED",{location.x+button_off.width*buttonscale+20,location.y+35},40,0,WHITE);
        else
            DrawTextEx(pencil,label.c_str(),{location.x+button_off.width*buttonscale+20,location.y+35},40,0,WHITE);
